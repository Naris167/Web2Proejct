    ...
    <div class="container-fluid w-75">
        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="col-sm-8">
                    <h5 class="font-baloo font-size-20">Mozzarella Sticks</h5>
                    <!-- product rating -->
                    <div class="d-flex">
                    <div class="rating text-warning font-size-12">
                        <span><i class="fas fa-star"></i></span>
                    ...
                    <div class="quantity-selector">
                        <div class="quantity-controls">
                            <button class="qty-btn qty-down" data-id="Mozzarella Sticks">
                                <i class="fas fa-angle-down"></i>
                            </button>
                            <input
                                type="text"
                                data-id="Mozzarella Sticks"
                                class="qty_input"
                                value="1"
                                placeholder="1"
                            />
                            <button class="qty-btn qty-up" data-id="Mozzarella Sticks">
                                <i class="fas fa-angle-up"></i>
                            </button>
                        </div>
                    </div>
